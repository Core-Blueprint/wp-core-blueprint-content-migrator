...
- Add selective post and taxonomy migration with guarded source-ID validation, required parent dependencies and relationship filtering.
...
- Require Core Blueprint Base 1.0.0-rc1+ with compatible Core API 1.1 for the migration runtime.
...
- Added required Core Blueprint Extension Registry and Governance integration.
